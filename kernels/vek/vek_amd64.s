...
dwblk8k3s1_loop:
	...
	VFMADD231PS 0(DX), Y10, Y0
	VFMADD231PS 32(DX), Y11, Y0
	VFMADD231PS 64(DX), Y12, Y0
	VFMADD231PS 0(R8), Y13, Y0
	VFMADD231PS 32(R8), Y14, Y0
	VFMADD231PS 64(R8), Y15, Y0
	VMOVUPS Y0, (DI)
	ADDQ $32, SI
	ADDQ $32, DX
	ADDQ $32, R8
...
dwblk8k5s1_loop:
	...
	VMULPS 0(SI), Y2, Y0
	VMOVUPS 32(BX), Y2
	VFMADD231PS 32(SI), Y2, Y0
	VMOVUPS 64(BX), Y2
	VFMADD231PS 64(SI), Y2, Y0
	VMOVUPS 96(BX), Y2
	VFMADD231PS 96(SI), Y2, Y0
	VMOVUPS 128(BX), Y2
	VFMADD231PS 128(SI), Y2, Y0
	VMOVUPS 160(BX), Y2
	VFMADD231PS 0(DX), Y2, Y0
	VMOVUPS 192(BX), Y2
	VFMADD231PS 32(DX), Y2, Y0
	VMOVUPS 224(BX), Y2
	VFMADD231PS 64(DX), Y2, Y0
	VMOVUPS 256(BX), Y2
	VFMADD231PS 96(DX), Y2, Y0
	VMOVUPS 288(BX), Y2
	VFMADD231PS 128(DX), Y2, Y0
	VMOVUPS 320(BX), Y2
	VFMADD231PS 0(R8), Y2, Y0
	VMOVUPS 352(BX), Y2
	VFMADD231PS 32(R8), Y2, Y0
	VMOVUPS 384(BX), Y2
	VFMADD231PS 64(R8), Y2, Y0
	VMOVUPS 416(BX), Y2
	VFMADD231PS 96(R8), Y2, Y0
	VMOVUPS 448(BX), Y2
	VFMADD231PS 128(R8), Y2, Y0
	VMOVUPS 480(BX), Y2
	VFMADD231PS 0(R9), Y2, Y0
	VMOVUPS 512(BX), Y2
	VFMADD231PS 32(R9), Y2, Y0
	VMOVUPS 544(BX), Y2
	VFMADD231PS 64(R9), Y2, Y0
	VMOVUPS 576(BX), Y2
	VFMADD231PS 96(R9), Y2, Y0
	VMOVUPS 608(BX), Y2
	VFMADD231PS 128(R9), Y2, Y0
	VMOVUPS 640(BX), Y2
	VFMADD231PS 0(R10), Y2, Y0
	VMOVUPS 672(BX), Y2
	VFMADD231PS 32(R10), Y2, Y0
	VMOVUPS 704(BX), Y2
	VFMADD231PS 64(R10), Y2, Y0
	VMOVUPS 736(BX), Y2
	VFMADD231PS 96(R10), Y2, Y0
	VMOVUPS 768(BX), Y2
	VFMADD231PS 128(R10), Y2, Y0
	VMOVUPS Y0, (DI)
	ADDQ $32, SI
	ADDQ $32, DX
	ADDQ $32, R8
